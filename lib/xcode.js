...
const getVersion = _.memoize(getVersionWithoutRetry);
...
const getAutomationTraceTemplatePath = _.memoize(getAutomationTraceTemplatePathWithoutRetry);
...
const getMaxIOSSDK = _.memoize(getMaxIOSSDKWithoutRetry);
